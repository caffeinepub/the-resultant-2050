...
function ManifestoView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader, { id: "manifesto-part-i", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PartHeader,
        {
          roman: "I",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence, { children: "The transparent proprietary dome is fractured not by ideology, but by cryptographic proof. The sovereign key exits through the cracks." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader, { id: "manifesto-part-ii", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PartHeader,
        {
          roman: "II",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 11 — AI CONVENIENCE", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Attention algorithms operate through selection, reinforcement, and normalisation. You are exposed to statistically preferred narratives. Repeated exposure produces familiarity. Familiar becomes inevitable. You do not choose against the system — the impulse to choose never forms. The absence of resistance does not emerge from weakness. It emerges from the absence of perceived alternatives." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 10 — DAO ILLUSION", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Governance tokens grant voting rights. The admin key remains with the founding team. You participate. You do not control. The DAO is the most sophisticated form of captured governance ever devised — it provides the legitimacy of participation and the reality of centralisation simultaneously." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 9 — LIQUIDITY ROUTING", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Your capital flows through state-regulated channels. Stablecoin issuers maintain blacklists. Your address can be frozen without trial, without appeal, and without the operator needing to disclose the reason. Liquidity is the oxygen of financial life. Control the oxygen supply: control the life." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseHeader, { label: "PHASE II — THE MIDDLE TRAP (LAYERS 8–5)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 8 — CBDC SETTLEMENT", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "The EU Digital Euro, FedNow, and equivalent systems embed identity at the infrastructure level through jurisdiction-based transaction routing. Every transaction carries your identity. There is no privacy tier. There is only permission or denial." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 7 — STATE DATABASE", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Your identity, history, and biometrics are stored in centralised databases. Administrators can edit, delete, leak, or selectively disclose. Over 10 billion identity records have been exposed in centralised KYC breaches — the security offered is not absolute, it is merely shared risk that you bear individually." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 6 — EMERGENCY PAUSE", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Smart contracts include admin functions. When you threaten the system, the pause is pulled. This is not a bug. It is a feature — designed to ensure that no application on controlled infrastructure can operate outside the system's terms indefinitely." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 5 — SESSION BAN", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Your IP, device fingerprint, and behavioural profile are logged. Typing cadence, scroll pattern, application usage sequence — the combination is unique for 99.7% of users. When you resist, your session ends. You are not banned for what you did. You are banned for who you are, as the system has determined who that is." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseHeader, { label: "PHASE III — THE PHYSICAL END (LAYERS 4–1)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 4 — BIOMETRIC ID", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Your face, fingerprints, and gait become system-owned assets. You cannot change them. You cannot revoke them. Once enrolled, your body is a key that someone else holds a copy of." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 3 — TIME EDITING", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Centralised servers control the timestamp. They can claim a transaction never happened. They can make you guilty by retroactive reclassification. He who controls the clock controls history." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 2 — NETWORK FILTERING", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Terrestrial fibre passes through state-controlled chokepoints. Your packets can be dropped, delayed, or duplicated. The network is not neutral infrastructure — it is a control surface that has been largely invisible because it has been largely unused against individuals. Until it is needed." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 1 — THE KILL-SWITCH", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "AWS root access, data centre seizures, DNS root zone manipulation. The lever is pulled. Your entire digital reality goes dark. Not your funds — your existence. Everything you have built on someone else's infrastructure disappears at the cost of one administrative action." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence, { children: "The dead bird at the base is the proof. You did not configure your system. You were processed into data." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader, { id: "manifesto-part-iii", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PartHeader,
        {
          roman: "III",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "The sovereign stack does not eliminate complexity. It redistributes it — from institutional custody to individual responsibility." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
...
function TrapNav({ activeSection, navItems, essayLabel }) {
  ...
  const accentActive = isKey ? "oklch(55% 0.14 160 / 0.5)" : "oklch(55% 0.12 240 / 0.5)";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center justify-between px-8 lg:px-16 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: isKey ? "HEXALOGY VI" : "HEXALOGY V"
            }
          ),
            ...
            children: navItems.map((item) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    color: isActive ? isKey ? "oklch(72% 0.14 160)" : "oklch(78% 0.15 240)" : "oklch(45% 0.008 240)",
...
function App() {
  ...
  const navItems = essay === "trap" ? TRAP_NAV_ITEMS : essay === "key" ? KEY_NAV_ITEMS : MANIFESTO_NAV_ITEMS;
  reactExports.useEffect(() => {
    const items = essay === "trap" ? TRAP_NAV_ITEMS : essay === "key" ? KEY_NAV_ITEMS : MANIFESTO_NAV_ITEMS;
  ...
  const accentColor = isManifesto ? "oklch(65% 0.13 85)" : isKey ? "oklch(60% 0.14 160)" : "oklch(62% 0.15 240)";
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  const essayLabel = isManifesto ? "THE SOVEREIGNTY MANIFESTO" : isKey ? "THE KEY" : "THE TRAP";
  const heroImage = isManifesto ? "/assets/uploads/BeFree-2.png" : isKey ? "/assets/uploads/Key-1.png" : "/assets/uploads/Trap-3.png";
  const heroImageAlt = isManifesto ? "The Sovereignty Manifesto" : isKey ? "The Key" : "The Trap";
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isManifesto ? "SOVEREIGNTY SERIES" : isKey ? "HEXALOGY VI" : "HEXALOGY V" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  borderRadius: "2px",
                  border: `1px solid ${isManifesto ? "oklch(30% 0.1 85 / 0.4)" : isKey ? "oklch(30% 0.1 160 / 0.4)" : "oklch(30% 0.08 240 / 0.4)"}`
                },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isManifesto ? "Engineering the Exit from the Legacy Capture Stack" : isKey ? "The Sixth Essay — On the Architecture of Resistance" : "The Fifth Essay — On the Architecture of Invisible Capture"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "font-mono-code text-xs tracking-widest",
                style: {
                  color: isManifesto ? "oklch(40% 0.1 85)" : isKey ? "oklch(40% 0.1 160)" : "oklch(35% 0.07 240)"
                },
                children: "Q4 2026"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  width: "100%",
                  height: "1px",
                  background: `linear-gradient(to right, ${isManifesto ? "oklch(55% 0.12 85 / 0.4)" : isKey ? "oklch(55% 0.14 160 / 0.4)" : "oklch(55% 0.12 240 / 0.4)"}, transparent)`,
                  marginTop: "2.5rem",
                  marginBottom: "2.5rem"
                }
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isManifesto ? "Freedom is not absence of control. Freedom is absence of unilateral control." : isKey ? "Resistance is not a political act. It is an engineering decision." : "The blockchain did not liberate finance. It became its nervous system."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isManifesto ? "A structured analysis of the eleven-layer Legacy Capture Stack and its sovereign architectural alternatives." : isKey ? "While the 90% live inside the system, the 10% build a parallel one — using its materials, against its logic." : "Q4 2026 is the moment the distinction between crypto and traditional finance ceased to exist. The trap is not a prison. It is a service. And that is what makes it perfect."
              }
            )
          ]
        }
      ),
      isManifesto ? /* @__PURE__ */ jsxRuntimeExports.jsx(ManifestoView, {}) : isKey ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4", children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      ...
                      style: {
                        color: isManifesto ? "oklch(45% 0.1 85)" : isKey ? "oklch(45% 0.1 160)" : "oklch(40% 0.07 240)"
                      },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: isManifesto ? "THE SOVEREIGNTY MANIFESTO" : isKey ? "HEXALOGY VI · THE KEY" : "HEXALOGY V · THE TRAP"
              }
            )
          ] })
        }
