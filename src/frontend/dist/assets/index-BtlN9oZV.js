    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-3xl mx-auto px-6 md:px-10 lg:px-14 xl:px-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: ["trap", "key"].map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isKey ? "HEXALOGY VI" : "HEXALOGY V" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isKey ? "The Sixth Essay — On the Architecture of Resistance" : "The Fifth Essay — On the Architecture of Invisible Capture"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  width: "100%",
                  height: "1px",
                  background: `linear-gradient(to right, ${isKey ? "oklch(55% 0.14 160 / 0.4)" : "oklch(55% 0.12 240 / 0.4)"}, transparent)`,
                  marginTop: "2.5rem",
                  marginBottom: "2.5rem"
                }
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isKey ? "Resistance is not a political act. It is an engineering decision." : "The blockchain did not liberate finance. It became its nervous system."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isKey ? "While the 90% live inside the system, the 10% build a parallel one — using its materials, against its logic." : "Q4 2026 is the moment the distinction between crypto and traditional finance ceased to exist. The trap is not a prison. It is a service. And that is what makes it perfect."
              }
            )
          ]
        }
      ),
      isKey ? KEY_PILLARS.map((pillar) => /* @__PURE__ */ jsxRuntimeExports.jsx(KeyPillarSection, { pillar }, pillar.id)) : TRAP_PILLARS.map((pillar) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrapPillarSection, { pillar }, pillar.id)),
      isKey ? /* @__PURE__ */ jsxRuntimeExports.jsx(KeyConvergenceSection, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(TrapConvergenceSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "footer",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: isKey ? "HEXALOGY VI · THE KEY" : "HEXALOGY V · THE TRAP"
              }
            )
          ] })
        }
