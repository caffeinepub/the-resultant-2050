...
const KEY_PILLARS = [
  {
    ...
    subtitle: "The cognitive layer precedes the financial layer. The system captures minds before wallets.",
...
Cognitive sovereignty is not philosophical preference. It is the precondition for every operational decision that follows. A person whose definition of financial normality has been algorithmically constructed cannot evaluate the parallel economy, the invisible fortress, or the legal arsenal on their merits. They evaluate them against a baseline that was installed without consent.`,
    ...
    invisibleHand: {
      experience: "Engaged, informed, financially active. A sense of participation and agency in one's own financial life.",
      reality: "A population whose definition of financial normality has been algorithmically constructed, and whose impulse to question that normality has been systematically dampened through 36-month reward cycles they did not design."
    },
    thread: "*Thread asked what the atomic unit of value is in a networked world. The Swarm showed how distributed signals produce coordinated belief without central authority. The attention algorithm is a Swarm mechanism applied to cognition: no single actor constructs the belief landscape, but the aggregate of engagement signals produces a manufactured normality. The sovereign begins not with financial decisions but with the recovery of the cognitive frame from which decisions are made.*",
    essences: [
  ...
  },
  {
    ...
    romanNumeral: "II",
    title: "THE NEW CRIME",
    subtitle: "In a permissioned world, the unauthorised act is criminal by definition.",
...
The non-obvious legal paradox: MiCA, designed to close permissionless financial activity, creates a licensed pathway for precisely that activity at institutional scale. The regulatory framework designed to shut the system provides the 10% with the legal architecture to operate within it autonomously. The door was not locked. It was relabelled.`,
    ...
    invisibleHand: {
      experience: "A regulated, orderly financial market that protects consumers from unscrupulous operators.",
      reality: "Licensed entities performing sovereign financial behavior with regulatory cover that unlicensed individuals cannot access — identical behavior, different legal classification, determined entirely by a €50,000 administrative process."
    },
  ...
  },
  {
    ...
    subtitle: "The sovereign's first weapon is control over their own signature.",
...
The non-obvious insight: the system does not require identity. It requires uniqueness. The combination of typing cadence, scroll pattern, application usage sequence, device fingerprint, and purchase timing is unique for 99.7% of users. The system has a de facto identity without a name. The sovereign's objective is not to disappear. It is to be indistinguishable from thousands of others — to produce a behavioral profile with no unique signature.`,
    synchrony: "The invisible fortress is the technical complement to the legal architecture of Pillar II. The license provides regulatory cover. The fortress provides operational invisibility. Without the fortress, the license is a compliance document attached to a transparent person. Without the license, the fortress is an unmarked target.",
    invisibleHand: {
      experience: "A compliant, licensed entity with standard behavioral metrics and unremarkable usage patterns.",
      reality: "The individual behind the entity is operationally invisible at the identity layer while legally visible at the license layer. The system knows the entity exists. It cannot map the entity to a person."
    },
...
The system's offer of institutional security — deposit insurance, fraud protection, account recovery — is structurally dependent on individual security remaining difficult. If self-custodied security were as reliable as institutional security, the system would lose its retention mechanism. The security gap is not incidental to the service model. It is the service model. The system creates and maintains a market for security by ensuring the alternative is genuinely hard.`,
    synchrony: "Pillar IV is the cost function of Pillar III. The invisible fortress describes what protection is required. The price of freedom describes why most individuals do not pay it. The 90% who remain inside the system are not wrong about the difficulty. They are making a correct assessment of an asymmetric burden — the burden is real, and the system has structured the alternative to be exactly as difficult as necessary to retain them.",
    invisibleHand: {
      experience: "A rational choice to accept managed security in exchange for institutional guarantees.",
      reality: "Individuals who have not constructed the security infrastructure required to exit, and who correctly assess that building it carries real costs and real risks — costs the system has deliberately structured into the alternative."
    },
...
The non-obvious operational window: DePIN's regulatory classification in 2026 remains ambiguous in most jurisdictions. Helium hotspot operators are classified as telecommunications hardware owners, not service providers. Akash compute providers are classified as cloud infrastructure operators. Neither classification triggers financial services regulation. The sovereign operating through DePIN uses infrastructure that the compliance framework has not yet categorised. This window closes. The architecture exists now.`,
    synchrony: "The parallel economy is the economic expression of the invisible fortress (Pillar III) operating under the legal cover of Pillar II. Without fortress-level operational security, participants in dark liquidity pools are identifiable. Without the licensed legal structure, their participation is legally undefended. The three pillars are mutually dependent: none functions at full capacity without the others.",
    invisibleHand: {
      experience: "VPN usage, privacy tool adoption, standard dark-web traffic patterns — individual user preferences.",
      reality: "A functioning parallel economic infrastructure settling value outside the compliance perimeter at volumes below the system's detection threshold, using legal infrastructure classifications that predate the surveillance framework."
    },
  ...
  },
  {
    ...
    subtitle: "The question is not what is true. The question is what can be proven to have existed before it was rewritten.",
...
The non-obvious insight: the epistemic weapon is the habit of recording before the fact. An event recorded in real-time, before the narrative forms, is epistemically unassailable. An event recorded after the narrative has formed is a claim. The sovereign who timestamps habitually does not respond to epistemic warfare — they pre-empt it. The weapon is not the technology. It is the practice.`,
    synchrony: "The epistemic war is the informational complement to the financial war. Pillar V describes value that moves without permission. Pillar VI describes facts that exist without permission. Both operate on the same principle: infrastructure-level permanence is more durable than application-level narrative. The system can rewrite the story. It cannot rewrite the hash.",
    invisibleHand: {
      experience: "A small minority of users employing blockchain archiving tools for technical or ideological reasons.",
      reality: "A distributed archive of the pre-synthetic record of reality that cannot be retroactively edited — whose strategic value increases in direct proportion to the volume of synthetic content the system generates."
    },
  ...
  },
  {
    ...
    subtitle: "Individual tactics are not architecture. Architecture requires community.",
...
The non-obvious insight: Network States do not require territory because 21st-century legitimacy is protocol-based, not geographic. The ISO 20022 standard is enforced by network membership, not by borders. A Network State implementing ISO 20022 for internal settlements uses the same compliance standard as the ECB. The system cannot distinguish its settlements from any other compliant actor's. The same standard, applied to sovereign infrastructure, repurposed against the logic it was designed to serve.`,
    synchrony: "The Network State is the collective architecture that makes all preceding pillars sustainable. Individual sovereignty is tactically sound. Collective sovereignty is architecturally stable. The Network State is what individual tactics become when they are organised into durable, self-reinforcing infrastructure with compounding network effects.",
    invisibleHand: {
      experience: "A compliant legal entity using standard financial messaging protocols and established communication tools.",
      reality: "A collective sovereign infrastructure using the system's own compliance standards to operate outside its control, at sufficient scale to generate network effects that make the architecture self-sustaining."
    },
    thread: "*Thread described the network as the atomic unit of value in the digital age. The Network State is the thesis of Thread applied to sovereignty: individual nodes, connected by protocol rather than by territory, generating collective resilience through distributed architecture. Six essays mapped the mechanism of capture. The Network State is the architectural counter-mechanism — built from the same materials, operating against the same logic.*",
    essences: [
...
const KEY_CONVERGENCE_ROWS = [
  {
    layer: "Psychology",
    weapon: "Trickster / Punk archetype + cognitive reframing",
    mechanism: "Dopamine loop used as camouflage, not capture; belief baseline maintained independently of algorithmic feed",
    systemSees: "Engaged user with normal retention metrics and compliant behaviour",
    actuallyHappens: "Individual operates within the algorithm without surrendering the cognitive frame from which decisions are made"
  },
  {
    layer: "Legal",
    weapon: "CASP license + jurisdictional arbitrage + treaty structures",
    mechanism: "Licensed entity bears compliance burden; individual retains operational sovereignty under regulatory cover",
    systemSees: "Compliant actor within the regulatory framework",
    actuallyHappens: "Self-custody and autonomous financial operations conducted with the same legal cover as institutional actors"
  },
  {
    layer: "Identity + OpSec",
    weapon: "ZKP + SSI + behavioural indistinguishability",
    mechanism: "Protocol-level identity separation; behavioral profile designed to match thousands of others, not to be absent",
    systemSees: "Standard user metrics; compliant entity with unremarkable behavioral signature",
    actuallyHappens: "Individual is unmappable to the licensed entity; behavioral fingerprint offers no unique identification surface"
  },
  {
    layer: "Security",
    weapon: "Hardware keys + multi-device architecture + obscurity",
    mechanism: "Physical and informational separation of sovereign from assets; threat model calibrated to state-level adversary",
    systemSees: "Standard security practices; no anomalous patterns",
    actuallyHappens: "A layered security architecture with no phone-based authentication, no public asset association, and no single point of failure accessible without physical presence"
  },
  {
    layer: "Economic + Physical",
    weapon: "DePIN + P2P dark liquidity + satellite connectivity",
    mechanism: "Value transfer and communication via infrastructure operating below compliance threshold in unclassified regulatory categories",
    systemSees: "VPN usage, privacy tool adoption, standard dark-web traffic",
    actuallyHappens: "Parallel economic infrastructure settling value outside the surveillance perimeter; geolocation dependency severed at the physical layer"
  },
  {
    layer: "Epistemic",
    weapon: "OpenTimestamps + Arweave + Nostr",
    mechanism: "Pre-synthetic timestamping of the authentic record before the narrative forms",
    systemSees: "Niche blockchain archiving activity; ideological usage of technical tools",
    actuallyHappens: "An immutable, distributed archive of pre-AI-generated reality; each timestamped record is a mathematical proof that defeats retroactive synthetic rewriting"
  },
  {
    layer: "Collective",
    weapon: "Network State + Meshtastic mesh + ISO 20022 repurposed",
    mechanism: "Collective infrastructure implementing the system's own compliance standards to operate outside its control",
    systemSees: "A compliant legal entity using standard financial messaging protocols",
    actuallyHappens: "A self-sustaining sovereign jurisdiction generating network effects — each new member increases the architecture's resilience, not just its size"
  }
];
const KEY_CLOSING = `Thread asked a question disguised as an observation: what is the atomic unit of value in a networked world? The Swarm showed how distributed agency produces coordinated outcomes without central authority. Order mapped how rule systems create compliance through architectural inevitability rather than enforcement. The Resultant 2050 projected the confluence of these forces into a single trajectory — concentration, biological passivity, the displacement of human agency by protocol. The Trap diagnosed the mechanism by which this trajectory became a service: invisible, frictionless, self-reinforcing. The Key does not provide an exit.
...
const CLOSING_PARAS$1 = KEY_CLOSING.split("\n\n");
function KeyConvergenceSection() {
  const ref = reactExports.useRef(null);
  const [copiedClosing, setCopiedClosing] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  const handleCopyClosing = async () => {
    await navigator.clipboard.writeText(KEY_CLOSING);
    setCopiedClosing(true);
    ue.success("Copied to clipboard", { duration: 2e3 });
    setTimeout(() => setCopiedClosing(false), 2e3);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              children: "THE ARCHITECTURE OF RESISTANCE"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "table",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "oklch(11% 0.006 240)" }, children: [
                    "Layer",
                    "Weapon",
                    "Mechanism",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: KEY_CONVERGENCE_ROWS.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      style: {
                        background: i % 2 === 0 ? "oklch(9.5% 0.005 240)" : "oklch(10.5% 0.005 240)",
                        borderBottom: i < KEY_CONVERGENCE_ROWS.length - 1 ? "1px solid oklch(15% 0.005 240)" : "none"
                      },
                      "data-ocid": `key_table.row.${i + 1}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "td",
                          {
                            className: "px-4 py-3 font-mono-code text-xs font-semibold",
                            style: { color: "oklch(60% 0.14 160)", whiteSpace: "nowrap" },
                            children: row.layer
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "td",
                          {
                            ...
                            style: { color: "oklch(52% 0.09 160)", maxWidth: "160px" },
                            children: row.weapon
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "key-closing", className: "mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-start justify-between gap-4 mb-6",
              "data-ocid": "key_closing.section",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: { color: "oklch(55% 0.14 160)" },
                    children: "CLOSING — SEAL THE HEXALOGY"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    "data-ocid": "key_closing.secondary_button",
                    children: copiedClosing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, style: { color: "oklch(65% 0.18 160)" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 })
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: CLOSING_PARAS$1.map((para, i) => {
                const isLast = i === CLOSING_PARAS$1.length - 1;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: {
                      ...
                      color: isLast ? "oklch(55% 0.008 270)" : "oklch(75% 0.01 270)",
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(45% 0.1 160)" }, children: "BYLINE —" }),
                  " Claude, Caffeine, Gemini, DeepSeek, ChatGPT, Mistral... and Valeriy Velchev (2026)"
                ]
              }
            )
          }
...
function MultiParagraph$1({ text }) {
  const paras = text.split("\n\n");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: paras.map((para, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "p",
    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, style: { color: "oklch(65% 0.18 240)" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function KeyPillarSection({ pillar }) {
  const ref = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const el = ref.current;
    if (!el) return;
...
${pillar.invisibleHand.reality}`;
  ...
  const essencesRaw = pillar.essences.map((e) => e.replace(/\*/g, "")).join("\n");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ref,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SubBlock$1,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(MultiParagraph$1, { text: pillar.mechanism })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SubBlock$1,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: "THE SYSTEM SEES"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(68% 0.01 270)", fontSize: "0.95rem" }, children: pillar.invisibleHand.experience })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "oklch(78% 0.01 270)", fontSize: "0.95rem" }, children: pillar.invisibleHand.reality })
                  ]
                }
              )
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: pillar.essences.map((essence) => {
                const clean2 = essence.replace(/\*/g, "");
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    style: {
...
const TEXT_MAIN$1 = "oklch(75% 0.01 270)";
const TEXT_MUTED$1 = "oklch(55% 0.008 270)";
const TEXT_BRIGHT$1 = "oklch(92% 0.012 85)";
...
function PartHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        className: "font-serif-display text-lg font-light",
        style: { color: TEXT_MUTED$1, fontStyle: "italic" },
        children: opening
      }
    )
  ] });
...
function LayerBlock({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: BORDER_TABLE, paddingTop: "1rem" }, children })
  ] });
}
...
function Para$1({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "p",
    {
      className: "leading-relaxed mb-4 last:mb-0",
      style: { fontSize: "1.05rem", color: TEXT_MAIN$1 },
      children
    }
  );
}
function Essence$1({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "mt-8 pt-5",
...
const CAPTURE_TABLE_ROWS = [
  {
    layer: "11 — AI",
    legacy: "Algorithmic curation shapes perceived reality. Impulse to resist is manufactured out of existence.",
    sovereign: "Cognitive sovereignty: separate cognitive space, pattern disruption, Trickster/Punk archetypes."
  },
  {
    layer: "10 — DAO",
    legacy: "Admin keys with founding team. Governance theatre.",
    sovereign: "On-chain governance via NNS. Forkable protocols. Code as the only constitution."
  },
  {
    layer: "9 — Liquidity",
    legacy: "State-regulated channels. Stablecoin blacklists. Address freezing without trial.",
    sovereign: "Dark pools, atomic swaps, P2P settlement under MiCA Article 68. Liquidity that does not ask."
  },
  {
    layer: "8 — CBDC",
    legacy: "Identity embedded at infrastructure. No privacy tier. Permission or denial.",
    sovereign: "Chain-key tokens (ckBTC, ckETH). No intermediary. Settlement without identity exposure."
  },
  {
    layer: "7 — State DB",
    legacy: "Centralised databases. Admin edit rights. 10B+ records breached.",
    sovereign: "Blockchain timestamps (OpenTimestamps + Arweave). Immutable hash anchoring. No admin."
  },
  {
    layer: "6 — Pause",
    legacy: "Admin functions in smart contracts. Emergency stops designed in by default.",
    sovereign: "Canister smart contracts on ICP. No admin. vetKeys for private key management on-chain."
  },
  {
    layer: "5 — Session",
    legacy: "IP/device bans. Behavioural profiling. 99.7% of users uniquely identifiable without name.",
    sovereign: "ZKP session authentication. Unlinkable DID sub-identities. Behavioural indistinguishability."
  },
  {
    layer: "4 — Biometric",
    legacy: "System-owned biometric data. Irrevocable enrollment.",
    sovereign: "Self-Sovereign Identity (SSI/ERC-734). Local credential storage. ZKP selective disclosure."
  },
  {
    layer: "3 — Time",
    legacy: "Centralised timestamp servers. Retroactive reclassification.",
    sovereign: "Consensus time. Block height finality. OpenTimestamps anchored to Bitcoin."
  },
  {
    layer: "2 — Network",
    legacy: "Terrestrial chokepoints. State packet filtering.",
    sovereign: "DePIN mesh (Helium, Akash). Satellite P2P. Geolocation severed at the physical layer."
  },
  {
    layer: "1 — Kill-Switch",
    legacy: "AWS root access. DNS root zone control. One administrative action = total darkness.",
    sovereign: "Threshold signatures (Chain Key Cryptography). Distributed validation. No single switch."
  }
];
const VERDICT_LINES = [
  {
    ...
    text: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: AMBER }, children: "unilateral" }),
      " control."
    ] })
  },
  {
...
function ManifestoView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader$1, { id: "manifesto-part-i", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PartHeader,
        {
          roman: "I",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(LayerBlock, { label: "LAYER 0 — HARDWARE TRUST", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Every digital system ultimately runs on physical hardware. If you do not control the hardware layer, every layer above it is rented, not owned. Legacy systems depend on cloud compute concentration — AWS, Google Cloud, Azure — where administrative access can terminate your operational existence without notice, without appeal, without due process." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "The sovereign alternative is hardware diversity and distributed attestation. DePIN — Decentralised Physical Infrastructure Networks — distributes compute, storage, and connectivity across nodes owned by their operators. Helium for wireless connectivity, Akash for compute, Filecoin for storage. These are not applications on someone else's infrastructure. They are parallel infrastructure whose kill-switch does not exist because there is no single operator to compel. On the Internet Computer Protocol, Chain Key Cryptography ensures that no single node holds a private key — threshold signatures require multi-node compromise, not a single facility seizure. Entropy is distributed. Control is not." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(LayerBlock, { label: "LAYER 1 — CONSENSUS: WHO CONTROLS TRUTH", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Legacy systems resolve uncertainty about state through institutional authority — clearing houses, central timestamp servers, settlement networks. A single authority defines final reality. This is efficient. It is also a single point of failure, a single point of manipulation, and a single point of compelled compliance." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Sovereign systems replace authority arbitration with mathematical consensus. Truth becomes a provable state transition, not an institutional declaration. Blockchain timestamps create proof of prior existence through a mechanism that cannot be retroactively corrupted: every subsequent block's hash depends on the previous block's hash, so a retroactive insertion invalidates the entire chain from that point forward. The Internet Computer's ATBFT adaptive consensus switches between leader mode (efficiency) and leaderless mode (resilience) based on network conditions — it does not require a trusted leader to exist. Consensus corruption requires majority economic capture. Institutional manipulation requires one phone call." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(LayerBlock, { label: "LAYER 2 — EXECUTION: WHERE RULES RUN", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Legacy execution occurs inside bank processors, exchange engines, and payment middleware. ISO 20022 functions as a pre-execution compliance filter — before your transaction runs, it is evaluated against identity, jurisdiction, and behavioural criteria. Execution depends on institutional approval. The institution can deny, delay, or redirect." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Canister smart contracts on the Internet Computer execute logic with mathematical finality. No administrator — not even their creator — can pause your code mid-calculation. ZK-proof verifiers enable private transactions: the network confirms validity without learning the details. Your will becomes law. Not because someone granted it. Because the mathematics enforces it." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "font-mono-code text-xs tracking-widest uppercase mb-4",
            style: { color: AMBER_DIM },
            children: "TABLE — THE SOVEREIGN STACK: LAYER SUMMARY"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "table",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "oklch(11% 0.006 240)" }, children: ["Layer", "Name", "Description"].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "th",
                    {
                      className: "font-mono-code text-left px-4 py-3",
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: STACK_TABLE_ROWS.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      style: {
                        background: i % 2 === 0 ? BG_CELL_A : BG_CELL_B,
                        borderBottom: i < STACK_TABLE_ROWS.length - 1 ? BORDER_ROW : "none"
                      },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence$1, { children: "The transparent proprietary dome is fractured not by ideology, but by cryptographic proof. The sovereign key exits through the cracks." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader$1, { id: "manifesto-part-ii", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PartHeader,
        {
          roman: "II",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseHeader, { label: "PHASE I — SOFT CAPTURE (LAYERS 11–9)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 11 — AI CONVENIENCE", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Attention algorithms operate through selection, reinforcement, and normalisation. You are exposed to statistically preferred narratives. Repeated exposure produces familiarity. Familiar becomes inevitable. You do not choose against the system — the impulse to choose never forms. The absence of resistance does not emerge from weakness. It emerges from the absence of perceived alternatives." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 10 — DAO ILLUSION", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Governance tokens grant voting rights. The admin key remains with the founding team. You participate. You do not control. The DAO is the most sophisticated form of captured governance ever devised — it provides the legitimacy of participation and the reality of centralisation simultaneously." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 9 — LIQUIDITY ROUTING", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Your capital flows through state-regulated channels. Stablecoin issuers maintain blacklists. Your address can be frozen without trial, without appeal, and without the operator needing to disclose the reason. Liquidity is the oxygen of financial life. Control the oxygen supply: control the life." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseHeader, { label: "PHASE II — THE MIDDLE TRAP (LAYERS 8–5)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 8 — CBDC SETTLEMENT", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "The EU Digital Euro, FedNow, and equivalent systems embed identity at the infrastructure level through jurisdiction-based transaction routing. Every transaction carries your identity. There is no privacy tier. There is only permission or denial." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 7 — STATE DATABASE", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Your identity, history, and biometrics are stored in centralised databases. Administrators can edit, delete, leak, or selectively disclose. Over 10 billion identity records have been exposed in centralised KYC breaches — the security offered is not absolute, it is merely shared risk that you bear individually." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 6 — EMERGENCY PAUSE", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Smart contracts include admin functions. When you threaten the system, the pause is pulled. This is not a bug. It is a feature — designed to ensure that no application on controlled infrastructure can operate outside the system's terms indefinitely." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 5 — SESSION BAN", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Your IP, device fingerprint, and behavioural profile are logged. Typing cadence, scroll pattern, application usage sequence — the combination is unique for 99.7% of users. When you resist, your session ends. You are not banned for what you did. You are banned for who you are, as the system has determined who that is." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhaseHeader, { label: "PHASE III — THE PHYSICAL END (LAYERS 4–1)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 4 — BIOMETRIC ID", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Your face, fingerprints, and gait become system-owned assets. You cannot change them. You cannot revoke them. Once enrolled, your body is a key that someone else holds a copy of." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 3 — TIME EDITING", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Centralised servers control the timestamp. They can claim a transaction never happened. They can make you guilty by retroactive reclassification. He who controls the clock controls history." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 2 — NETWORK FILTERING", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "Terrestrial fibre passes through state-controlled chokepoints. Your packets can be dropped, delayed, or duplicated. The network is not neutral infrastructure — it is a control surface that has been largely invisible because it has been largely unused against individuals. Until it is needed." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LayerBlock, { label: "LAYER 1 — THE KILL-SWITCH", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "AWS root access, data centre seizures, DNS root zone manipulation. The lever is pulled. Your entire digital reality goes dark. Not your funds — your existence. Everything you have built on someone else's infrastructure disappears at the cost of one administrative action." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence$1, { children: "The dead bird at the base is the proof. You did not configure your system. You were processed into data." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader$1, { id: "manifesto-part-iii", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PartHeader,
        {
          roman: "III",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "font-mono-code text-xs tracking-widest uppercase mb-4",
            style: { color: AMBER_DIM },
            children: "TABLE — CAPTURE STACK VS. SOVEREIGN STACK"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "table",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { style: { background: "oklch(11% 0.006 240)" }, children: ["Layer", "Legacy Mechanism", "Sovereign Mechanism"].map(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: CAPTURE_TABLE_ROWS.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      style: {
                        background: i % 2 === 0 ? BG_CELL_A : BG_CELL_B,
                        borderBottom: i < CAPTURE_TABLE_ROWS.length - 1 ? BORDER_ROW : "none"
                      },
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ...
                          {
                            className: "px-4 py-3 text-xs leading-relaxed",
                            style: { color: TEXT_MUTED$1, maxWidth: "220px" },
                            children: row.legacy
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ...
                          {
                            className: "px-4 py-3 text-xs leading-relaxed",
                            style: { color: TEXT_MAIN$1, maxWidth: "220px" },
                            children: row.sovereign
                          }
                        )
                      ]
                    },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Para$1, { children: "The sovereign stack does not eliminate complexity. It redistributes it — from institutional custody to individual responsibility." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "font-mono-code text-xs tracking-widest uppercase mb-4",
                style: { color: AMBER_DIM },
                children: "ARCHITECTURAL VERDICT"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mb-10", children: [
            ...
            {
              className: "leading-relaxed",
              style: { fontSize: "1.1rem", color: TEXT_MAIN$1 },
              children: line
            },
            line.slice(0, 30)
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: VERDICT_LINES.map(({ key, text, bright }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "leading-relaxed mb-3 last:mb-0 font-serif-display text-lg",
                  style: {
                    color: bright ? TEXT_BRIGHT$1 : TEXT_MAIN$1,
                    fontStyle: "italic"
                  },
                  children: text
                },
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  style: { color: "oklch(30% 0.005 270)" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: AMBER_DIM }, children: "BYLINE —" }),
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Claude · Caffeine · Gemini · DeepSeek · ChatGPT · Mistral … and Valeriy Velchev (2026)" })
                  ]
                }
              )
            }
...
function Essence({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 pt-5", style: { borderTop: `1px solid ${RED_BORDER}` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "p",
    {
      className: "font-serif-display text-base leading-snug",
...
function PhoneSpyView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader, { id: "phonespy-pillar-i", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillarHeader,
        {
          roman: "I",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "Why did we agree to this? Because it was easy and “free.” We traded our freedom for a bit more photo storage and for algorithms that tell us what to watch. Every time you click “Accept,” you sign a contract that makes you a digital slave. We think the internet serves us, but the truth is, we are the free laborers feeding it with our lives." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence, { children: "We love our chains because they are free." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader, { id: "phonespy-pillar-ii", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillarHeader,
        {
          roman: "II",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "In 2030, the only path to freedom is owning your tech. If your data is on someone else’s server, you are a tenant. If your power depends on someone else’s switch, you are a hostage. True freedom means your computer works even if the rest of the world decides to turn you off. Own your tech, or it will own you." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence, { children: "Be an owner, not a tenant." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionFader, { id: "phonespy-pillar-iii", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillarHeader,
        {
          roman: "III",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Para, { children: "The world has split into two groups. On one side are the “Lords” – the big companies that own the internet. On the other side are the “serfs” – all of us, who own nothing and till their digital fields. In this world, your data is the new land. If you don’t have your own place in the network, you are just a number on someone’s list. Being independent is no longer a trend; it’s a matter of survival." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Essence, { children: "The new digital feudalism." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Freedom is a configuration, not a right."
                }
              )
            }
          ),
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  style: { color: "oklch(30% 0.005 270)" },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: RED_DIM }, children: "BYLINE —" }),
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Claude · Caffeine · Gemini · DeepSeek · ChatGPT · Mistral … and Valeriy Velchev (2026)" })
                  ]
                }
...
const TRAP_PILLARS = [
  {
    ...
    subtitle: "How tokenized finance becomes indistinguishable from traditional banking",
...
The exit remains technically possible. A user can withdraw cash, hold physical currency, transact outside the system. The friction is not a wall. It is a slope. Each step away from the system costs: conversion fees, settlement delays, liquidity spreads, tax reporting complexity. The system does not prevent exit. It prices exit into irrelevance.`,
    ...
    invisibleHand: {
      experience: "Higher yield on savings accounts, faster international transfers, lower fees.",
      reality: "Every financial instrument they hold is now a programmable token, subject to smart contract conditions they did not negotiate, operating under compliance rules they cannot inspect, in a system they cannot exit without significant personal cost."
    },
    thread: "BUIDL becomes collateral → ERC-3643 makes compliance atomic → ISO 20022 makes every transaction machine-readable → the user is inside a programmable financial system without awareness of entry."
  },
  {
    id: "pillar-ii",
    romanNumeral: "II",
    title: "THE THREE COMPLIANCE LAYERS",
    subtitle: "ISO 20022 + ERC-3643 + Chain Fusion = programmable regulated liquidity",
...
Third: ESG classification fields in ISO 20022 create programmable capital allocation. A pension fund mandate requiring 40% ESG-classified assets is enforceable at the protocol level. Capital routing through the system automatically calculates ESG exposure and blocks transfers that would violate mandates. The investment mandate is no longer a policy document. It is executable code.`,
    synchrony: "The three layers reached operational maturity simultaneously because they were designed around the same regulatory horizon: MiCA enforcement, SWIFT ISO 20022 migration, and the BIS Project Agorá timeline. The synchrony is not emergent. It is the result of a decade of Basel Committee working groups whose outputs — published in technical standards documents, not press releases — defined the architecture before a single line of production code was written.",
    invisibleHand: {
      experience: "Seamless, fast, cheap financial services.",
      reality: "Every unit of capital in the system moves only where the protocol permits, under conditions set by regulators, institutions, and mandate managers — none of whom are the user."
    },
    thread: "ISO 20022 declares identity → ERC-3643 enforces it at the asset level → Chain Fusion executes across chains without intermediary intervention → capital knows where it can go before it moves."
  },
  {
    id: "pillar-iii",
    romanNumeral: "III",
    title: "THE SEPTEMBER FILTER",
    subtitle: "MiCA + Project Agorá + Nasdaq Tokenization = the simultaneous closing of exits",
...
Q4 2026, concurrent: Project Agorá transitions from pilot to operational phase. Agorá is the BIS-coordinated project integrating wholesale CBDC settlement with commercial bank deposit tokenization across seven central bank jurisdictions (Federal Reserve, ECB, Bank of England, Bank of Japan, Bank of Korea, Banco de Mexico, Swiss National Bank). The operational phase embeds identity at the base layer of every transaction in these jurisdictions. Commercial bank deposits — the form of money held by 95% of people in these jurisdictions — become tokenized instruments that carry issuer identity, holder identity, and transaction purpose at the infrastructure level. Anonymity is not banned. It is architecturally absent. There is no anonymous field in the data structure. The absence is permanent because it is foundational.`,
    ...
    invisibleHand: {
      experience: "Better consumer protection, safer platforms, more reliable services.",
      reality: "Every firm that offered any degree of financial privacy, permissionless access, or regulatory arbitrage is removed from the accessible market. The architecture that remains is fully surveilled, fully compliant, and fully interoperable — with the identity infrastructure of every participating central bank."
    },
    thread: "MiCA removes unlicensed actors through banking infrastructure withdrawal → Nasdaq Tokenization creates the institutional replacement → Agorá embeds identity into the monetary base layer → the filter runs once, the exits close permanently."
  },
  {
    id: "pillar-iv",
    romanNumeral: "IV",
...
Three non-obvious connections: VC secondary liquidity combined with ERC-3643 identity reuse creates continuous private equity liquidity pools — the 7–10 year lock-up collapses, and liquid PE attracts more institutional capital, which accelerates concentration. ICP Chain Fusion combined with capital markets infrastructure creates an invisible execution backend for institutions that cannot publicly associate with blockchain — the sovereign wealth fund's settlement instructions run on ICP smart contracts with no visible blockchain exposure. ESG scoring combined with liquidity pool routing creates programmable capital allocation filters — capital that does not meet ESG thresholds finds fewer available yield opportunities without any individual transaction being blocked. The allocation filter operates through price signals, not prohibition.`,
    synchrony: "The middleware layer wars reached decisive phase in Q4 2026 because the regulated market finally provided institutional clients with the compliance cover to deploy capital through these systems. Before MiCA, the institutional hesitation was not technical — the infrastructure was operational. It was regulatory. Once the filter ran and the unlicensed sector was cleared, the institutional middleware providers inherited a market that had been architecturally prepared for them.",
    invisibleHand: {
      experience: "Seamless, fast financial services with no visible intermediary.",
      reality: "Each layer of the financial infrastructure stack is controlled by a specific entity with specific incentives, and the aggregate of these controls determines where capital can flow, at what cost, and under what conditions."
    },
    thread: "Middleware wars replace human intermediaries with protocol infrastructure → public chains are occupied not replaced → the winner of each layer installs an invisible toll → the aggregate is a financial system with no visible operator and no accessible point of leverage."
  },
  {
    id: "pillar-v",
    romanNumeral: "V",
...
Every previous system of financial control required enforcement: tax collection agents, capital controls with border checks, banking regulations with compliance officers. Enforcement requires awareness — the enforcer knows the rule, the regulated knows the rule. The frictionless trap requires no enforcement because it requires no awareness. The rule is not stated. It is embedded in the architecture. The user cannot violate the rule because the rule is a physical property of the system, like gravity. No one enforces gravity. It simply operates.`,
    synchrony: "The frictionless architecture was not deployed in Q4 2026 — it was completed there. The individual components (mobile banking UX, instant settlement infrastructure, tokenized yields) had been deployed incrementally over seven years. What Q4 2026 provides is the final layer: the compliance infrastructure that makes the frictionless system self-contained. Before Q4 2026, a user who wanted to exit the system had somewhere to go. After Q4 2026, the destination — the unlicensed, permissionless alternative — has been architecturally removed. The exit door was not locked. The corridor to it was demolished.",
    invisibleHand: {
      experience: "A financial life that is easier, faster, and more convenient than any previous generation.",
      reality: "Sovereignty over financial decisions — where capital goes, under what conditions, for what purposes — has migrated from the individual to the protocol. The individual retains the experience of agency. The substance of agency resides elsewhere."
    },
    thread: "Friction elimination removes decision points → each layer of UX hides one layer of the custody chain → exit costs compound with every month of participation → the system absorbs agency without ever demanding it."
  }
];
const TRAP_CONVERGENCE_ROWS = [
  {
    layer: "Identity",
  ...
  },
  {
    ...
    reality: "Data provider controls settlement conditions for all linked contracts"
  },
  {
    layer: "Market Access",
  ...
  },
  {
    ...
    reality: "Every unit of currency carries embedded identity and purpose code"
  },
  {
    layer: "Custody",
    ...
    reality: "Bank deposits are tokenized instruments in institutional infrastructure"
  },
  {
    layer: "Capture",
    ...
    reality: "Sovereignty migrates from individual to protocol without declared transfer"
  }
];
const TRAP_CLOSING = `The architecture described in these five pillars has one structural property that all previous systems of control lacked: it operates without declaring itself. Every preceding system — feudal taxation, colonial banking, fiat monetary control — required a visible point of authority. A king, a central bank, a border control. The visible point of authority is also the visible point of resistance. Revolutions locate the king. Bank runs target the central bank. Capital flight finds the border.
...
function TrapConvergenceSection() {
  const ref = reactExports.useRef(null);
  const [copiedClosing, setCopiedClosing] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const el = ref.current;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              children: "THE ARCHITECTURE OF CAPTURE"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "table",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: TRAP_CONVERGENCE_ROWS.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      style: {
                        background: i % 2 === 0 ? "oklch(9.5% 0.005 240)" : "oklch(10.5% 0.005 240)",
                        borderBottom: i < TRAP_CONVERGENCE_ROWS.length - 1 ? "1px solid oklch(15% 0.005 240)" : "none"
                      },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "closing", className: "mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-start justify-between gap-4 mb-6",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: copiedClosing ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12, style: { color: "oklch(65% 0.18 240)" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 })
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: CLOSING_PARAS.map((para, i) => {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                style: { color: "oklch(30% 0.005 270)" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(40% 0.07 240)" }, children: "BYLINE —" }),
                  " Claude, Caffeine, Gemini, DeepSeek, ChatGPT, Mistral... and Valeriy Velchev (2026)"
                ]
              }
            )
...
function TrapNav({ activeSection, navItems, essayLabel }) {
  ...
  const accentActive = isPhoneSpy ? "oklch(55% 0.18 25 / 0.5)" : isKey ? "oklch(55% 0.14 160 / 0.5)" : "oklch(55% 0.12 240 / 0.5)";
  const colorActive = "oklch(88% 0.015 85)";
  const navHexLabel = isPhoneSpy ? "PHONESPY" : isKey ? "HEXALOGY VI" : "HEXALOGY V";
  const navHexColor = isPhoneSpy ? "oklch(45% 0.15 25)" : isKey ? "oklch(45% 0.1 160)" : "oklch(35% 0.06 240)";
  const mobileAccentColor = isPhoneSpy ? "oklch(62% 0.18 25)" : isKey ? "oklch(55% 0.14 160)" : "oklch(55% 0.1 240)";
  const mobileActiveColor = isPhoneSpy ? "oklch(72% 0.18 25)" : isKey ? "oklch(72% 0.14 160)" : "oklch(78% 0.15 240)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: "fixed top-0 left-0 right-0 z-50 transition-all duration-300",
      style: {
        background: scrolled ? "oklch(7% 0.004 240 / 0.97)" : "oklch(7% 0.004 240 / 0.0)",
        borderBottom: scrolled ? "1px solid oklch(18% 0.006 240)" : "1px solid transparent",
        backdropFilter: scrolled ? "blur(12px)" : "none"
      },
      "aria-label": "Essay navigation",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center justify-between px-8 lg:px-16 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "font-mono-code text-xs tracking-widest",
              style: { color: navHexColor },
              children: navHexLabel
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: navItems.map((item) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  ...
                  border: `1px solid ${isActive ? accentActive : "oklch(22% 0.006 240)"}`,
                  borderRadius: "2px"
                },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex items-center justify-between px-5 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "font-mono-code text-xs tracking-widest",
...
function TrapPillarSection({ pillar }) {
  const ref = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const el = ref.current;
    if (!el) return;
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SubBlock,
          {
            ...
            sectionKey: "mechanism",
            copyText: pillar.mechanism,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(MultiParagraph, { text: pillar.mechanism })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SubBlock,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "thread-line italic", children: pillar.thread })
            ]
          }
        )
      ]
...
function App() {
  const [essay, setEssay] = reactExports.useState("key");
  const [activeSection, setActiveSection] = reactExports.useState("");
  const heroRef = reactExports.useRef(null);
  const navItems = essay === "trap" ? TRAP_NAV_ITEMS : essay === "key" ? KEY_NAV_ITEMS : essay === "manifesto" ? MANIFESTO_NAV_ITEMS : PHONESPY_NAV_ITEMS;
  reactExports.useEffect(() => {
    const items = essay === "trap" ? TRAP_NAV_ITEMS : essay === "key" ? KEY_NAV_ITEMS : essay === "manifesto" ? MANIFESTO_NAV_ITEMS : PHONESPY_NAV_ITEMS;
  ...
  const accentColor = isPhoneSpy ? "oklch(62% 0.18 25)" : isManifesto ? "oklch(65% 0.13 85)" : isKey ? "oklch(60% 0.14 160)" : "oklch(62% 0.15 240)";
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  const essayLabel = isPhoneSpy ? "YOUR PHONE IS BETRAYING YOU" : isManifesto ? "THE SOVEREIGNTY MANIFESTO" : isKey ? "THE KEY" : "THE TRAP";
  const heroImage = isPhoneSpy ? "/assets/uploads/PhoneSpy-1.png" : isManifesto ? "/assets/uploads/BeFree-2.png" : isKey ? "/assets/uploads/Key-1.png" : "/assets/uploads/Trap-3.png";
  const heroImageAlt = isPhoneSpy ? "Phone Spy" : isManifesto ? "The Sovereignty Manifesto" : isKey ? "The Key" : "The Trap";
  const heroBorderColor = isPhoneSpy ? "oklch(30% 0.12 25 / 0.4)" : isManifesto ? "oklch(30% 0.1 85 / 0.4)" : isKey ? "oklch(30% 0.1 160 / 0.4)" : "oklch(30% 0.08 240 / 0.4)";
  const dividerColor = isPhoneSpy ? "oklch(55% 0.18 25 / 0.4)" : isManifesto ? "oklch(55% 0.12 85 / 0.4)" : isKey ? "oklch(55% 0.14 160 / 0.4)" : "oklch(55% 0.12 240 / 0.4)";
  const footerAccent = isPhoneSpy ? "oklch(45% 0.15 25)" : isManifesto ? "oklch(45% 0.1 85)" : isKey ? "oklch(45% 0.1 160)" : "oklch(40% 0.07 240)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "oklch(7% 0.004 240)" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TrapNav,
      {
        activeSection,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-3xl mx-auto px-6 md:px-10 lg:px-14 xl:px-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ["trap", "key"].map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
                ...
                style: {
                  background: essay === e ? "oklch(14% 0.01 240)" : "oklch(9% 0.006 240)",
                  border: `1px solid ${essay === e ? e === "key" ? "oklch(55% 0.14 160 / 0.6)" : "oklch(55% 0.12 240 / 0.6)" : "oklch(22% 0.006 240)"}`,
                  color: essay === e ? e === "key" ? "oklch(72% 0.14 160)" : "oklch(72% 0.12 240)" : "oklch(38% 0.007 240)",
                  borderRadius: "2px"
                },
                "data-ocid": `essay_selector.${e}.toggle`,
                children: e === "trap" ? "V · THE TRAP" : "VI · THE KEY"
              },
              e
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: "font-mono-code text-xs tracking-widest px-4 py-2 transition-all duration-200",
                style: {
                  background: essay === "manifesto" ? "oklch(14% 0.01 240)" : "oklch(9% 0.006 240)",
                  border: `1px solid ${essay === "manifesto" ? "oklch(45% 0.12 85 / 0.6)" : "oklch(22% 0.006 240)"}`,
                  color: essay === "manifesto" ? "oklch(65% 0.13 85)" : "oklch(38% 0.007 240)",
                  borderRadius: "2px"
                },
                "data-ocid": "essay_selector.manifesto.toggle",
                children: "SM \\u00b7 THE MANIFESTO"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: "font-mono-code text-xs tracking-widest px-4 py-2 transition-all duration-200",
                style: {
                  background: essay === "phonespy" ? "oklch(14% 0.01 240)" : "oklch(9% 0.006 240)",
                  border: `1px solid ${essay === "phonespy" ? "oklch(55% 0.18 25 / 0.6)" : "oklch(22% 0.006 240)"}`,
                  color: essay === "phonespy" ? "oklch(72% 0.18 25)" : "oklch(38% 0.007 240)",
                  borderRadius: "2px"
                },
                "data-ocid": "essay_selector.phonespy.toggle",
                children: "PS \\u00b7 PHONE SPY"
              }
            )
          ]
        }
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isPhoneSpy ? "PHONESPY" : isManifesto ? "SOVEREIGNTY SERIES" : isKey ? "HEXALOGY VI" : "HEXALOGY V" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(22% 0.005 240)" }, children: "/" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "THREAD \\u00b7 THE SWARM \\u00b7 ORDER \\u00b7 THE RESULTANT 2050 \\u00b7 THE TRAP \\u00b7 THE KEY" })
                ]
              }
            ),
            isPhoneSpy ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  ...
                  children: "BETRAYING YOU"
                }
              )
            ] }) : isManifesto ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
                  className: "font-serif-display font-bold leading-none mb-2",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isPhoneSpy ? "Your software is their spy." : isManifesto ? "Engineering the Exit from the Legacy Capture Stack" : isKey ? "The Sixth Essay — On the Architecture of Resistance" : "The Fifth Essay — On the Architecture of Invisible Capture"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "font-mono-code text-xs tracking-widest",
                style: {
                  color: isPhoneSpy ? "oklch(40% 0.15 25)" : isManifesto ? "oklch(40% 0.1 85)" : isKey ? "oklch(40% 0.1 160)" : "oklch(35% 0.07 240)"
                },
                children: "Q4 2026"
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isPhoneSpy ? "Freedom is a configuration, not a right." : isManifesto ? "Freedom is not absence of control. Freedom is absence of unilateral control." : isKey ? "Resistance is not a political act. It is an engineering decision." : "The blockchain did not liberate finance. It became its nervous system."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: isPhoneSpy ? "The world of 2030 is organized, clean, and very convenient. But there is a catch: nothing belongs to you. Your money, your photos, your messages, and even your name are just entries in someone else's computer. If someone decides they don't like you – they simply delete you. And you cease to exist. This is not a movie. This is how technology is built today." : isManifesto ? "A structured analysis of the eleven-layer Legacy Capture Stack and its sovereign architectural alternatives." : isKey ? "While the 90% live inside the system, the 10% build a parallel one — using its materials, against its logic." : "Q4 2026 is the moment the distinction between crypto and traditional finance ceased to exist. The trap is not a prison. It is a service. And that is what makes it perfect."
              }
            )
          ]
        }
      ),
      isPhoneSpy ? /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneSpyView, {}) : isManifesto ? /* @__PURE__ */ jsxRuntimeExports.jsx(ManifestoView, {}) : isKey ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        KEY_PILLARS.map((pillar) => /* @__PURE__ */ jsxRuntimeExports.jsx(KeyPillarSection, { pillar }, pillar.id)),
        /* @__PURE__ */ jsxRuntimeExports.jsx(KeyConvergenceSection, {})
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        TRAP_PILLARS.map((pillar) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrapPillarSection, { pillar }, pillar.id)),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrapConvergenceSection, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "footer",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: isPhoneSpy ? "PHONESPY · YOUR PHONE IS BETRAYING YOU" : isManifesto ? "THE SOVEREIGNTY MANIFESTO" : isKey ? "HEXALOGY VI · THE KEY" : "HEXALOGY V · THE TRAP"
              }
            )
          ] })
        }
