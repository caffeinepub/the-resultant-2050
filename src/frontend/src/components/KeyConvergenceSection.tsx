import { KEY_CLOSING, KEY_CONVERGENCE_ROWS } from "@/data/key";
import { Check, Copy } from "lucide-react";
import { useEffect, useRef, useState } from "react";
import { toast } from "sonner";

const CLOSING_PARAS = KEY_CLOSING.split("\n\n");

export function KeyConvergenceSection() {
    ...
    >
      ...
      >
        ...
        >
          ...
          <tbody>
            {KEY_CONVERGENCE_ROWS.map((row, i) => (
              <tr
                key={row.layer}
                style={{
                  background:
                  ...
                  borderBottom:
                    i < KEY_CONVERGENCE_ROWS.length - 1
      ...
      {/* Closing section */}
      <div id="key-closing" className="mt-4">
        <div
        ...
        >
          ...
          >
            {copiedClosing ? (
              <Check size={12} style={{ color: "oklch(65% 0.18 160)" }} />
            ) : (
              <Copy size={12} />
            )}
          </button>
      ...
      >
        ...
        >
          <span style={{ color: "oklch(45% 0.1 160)" }}>BYLINE —</span> Claude,
